package org.apache.seatunnel.plugin.datasource.starrocks.metadata;
...
public class StarRocksCatalog extends AbstractJdbcCatalog {
    ...
    public StarRocksCatalog(BaseConnectionParam param, JdbcConnectionProvider connectionManager) {
